...
st.title('MEJORAS EN LA USABILIDAD DE LA APP BiciMad :world_map::')
...
if st.button("Calcular Ruta"):
    ...
    st.image(mapeo)
    st.write(f"Esta es tu ruta en bicicleta es desde Calle Alcalá 126 a Calle Alcalá 498 y tienes 5 bicicletas en la estación")
