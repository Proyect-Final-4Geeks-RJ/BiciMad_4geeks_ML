    ...
    with col2:
        ...
        # Crear el selectbox
            ...
            with st.container(): 
                ...
                nearest_station_in = get_nearest_bike_station(user_location, station_data)
                nearest_station_out = get_nearest_bike_station(user_location, station_data)
                ...
                def main():
                    ...
                    if st.button('Prueba el uso'):
                     ...
                     # Find nearest bike stations
                                nearest_station_in = get_nearest_bike_station(start_coords[1], start_coords[0])
                                nearest_station_out = get_nearest_bike_station(end_coords[1], end_coords[0])
